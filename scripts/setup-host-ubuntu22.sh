...
log "  3. 确保 ACR 中已存在以下镜像（docker-compose 会从这些路径拉取）："
log "       • ${ACR_REGISTRY}/${ACR_NAMESPACE}/mysql:8.0"
log "       • ${ACR_REGISTRY}/${ACR_NAMESPACE}/debian:13.4"
log "       • ${ACR_REGISTRY}/${ACR_NAMESPACE}/uv:0.11.6-python3.13-trixie"
log "       • ${ACR_REGISTRY}/${ACR_NAMESPACE}/gosu:1.19-trixie"
