...
TOOLSETS = {
    ...
    "hermes-codeshark": {
        "description": "CodeShark bot toolset - CodeShark workspace integration platform (full access, incl. terminal for workspace sync)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
