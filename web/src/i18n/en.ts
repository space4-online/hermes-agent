...
export const en: Translations = {
  ...
  skills: {
    ...
    namePlaceholder: "skill-name (lowercase, digits, _, -)",
    categoryPlaceholder: "category (optional, e.g. productivity)",
    contentPlaceholder: "SKILL.md content (may include YAML frontmatter)",
    delete: "Delete",
    deleteConfirmTitle: "Delete skill",
    deleteConfirmHint: "This permanently deletes the skill directory and all its files.",
    deleted: "Deleted",
    deleteFailed: "Delete failed",
    readOnlyBadge: "Read-only",
    readOnlyHint: "Built-in skill is read-only. Clone to ~/.hermes/skills/ to edit.",
    cloneToUser: "Clone to user dir",
    sourceDir: "Source dir",
    pathLabel: "Path",
    nameRequired: "Skill name required",
    contentRequired: "Content required",
    invalidName: "Name must be alphanumeric, _ or -",
  ...
  memory: {
    ...
    banksTab: "Banks",
    searchPlaceholder: "Full-text search facts...",
    minTrustLabel: "Min trust",
    factCount: "{count} fact{s}",
    entityCount: "{count} entit{ies}",
    bankCount: "{count} bank{s}",
    ...
    rebuildSuccess: "Bank rebuilt",
    rebuildFailed: "Rebuild failed",
    addFact: "New fact",
    addFactTitle: "Create fact",
    contentRequired: "Content required",
    factCreated: "Fact created",
    factCreateFailed: "Create failed",
    save: "Save",
    saved: "Saved",
    saveFailed: "Save failed",
    cancel: "Cancel",
    delete: "Delete",
    deleteConfirm: "Delete fact",
    deleteConfirmHint: "This permanently removes the fact and its entity links.",
    deleted: "Deleted",
    deleteFailed: "Delete failed",
    noFacts: "No facts yet. Click \"New fact\" to start.",
    noEntities: "No entities yet. Entities are auto-extracted from facts.",
    noBanks: "No banks yet. Banks are auto-built per category.",
    trustUp: "Trust +0.1",
    trustDown: "Trust -0.1",
    factDimDerived: "Entities and banks are derived from facts and not directly editable.",
