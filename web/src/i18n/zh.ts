...
export const zh: Translations = {
  ...
  skills: {
    ...
    create: "新建技能",
    createTitle: "新建技能",
    namePlaceholder: "技能名（小写、数字、- _）",
    categoryPlaceholder: "分类（可选，例如 productivity）",
    contentPlaceholder: "SKILL.md 内容（可包含 YAML frontmatter）",
    delete: "删除",
    deleteConfirmTitle: "删除技能",
    deleteConfirmHint: "将永久删除该技能目录及其所有文件。",
    deleted: "已删除",
    deleteFailed: "删除失败",
    readOnlyBadge: "只读",
    readOnlyHint: "内置技能只读。复制到 ~/.hermes/skills/ 后才可编辑。",
    cloneToUser: "复制到用户目录",
    sourceDir: "来源目录",
    pathLabel: "路径",
    nameRequired: "请输入技能名",
    contentRequired: "内容不能为空",
    invalidName: "技能名仅允许字母、数字、_ 和 -",
    invalidCategory: "分类格式无效",
    skillCreated: "技能已创建",
    createFailed: "创建失败",
  ...
  memory: {
    ...
    entitiesTab: "实体",
    banksTab: "记忆库",
    searchPlaceholder: "全文检索 facts...",
    minTrustLabel: "最低信任度",
    factCount: "{count} 条事实",
    entityCount: "{count} 个实体",
    bankCount: "{count} 个 bank",
    backendLabel: "后端",
    contentLabel: "内容",
    categoryLabel: "分类",
    tagsLabel: "标签",
    ...
    delete: "删除",
    deleteConfirm: "删除事实",
    deleteConfirmHint: "将永久移除该事实及其实体关联。",
    deleted: "已删除",
    deleteFailed: "删除失败",
    noFacts: "暂无事实。点击“新增事实”开始。",
    noEntities: "暂无实体。事实创建后会自动抽取实体。",
    noBanks: "暂无 bank。bank 按分类自动生成。",
    trustUp: "信任 +0.1",
    trustDown: "信任 -0.1",
    factDimDerived: "实体与 bank 由 fact 自动推导，不可手动编辑。",
    factsByCategory: "事实分类统计",
    edit: "编辑",
    loadFailed: "加载失败",
  },
};
